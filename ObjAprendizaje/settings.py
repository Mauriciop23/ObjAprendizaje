"""
Django settings for ObjAprendizaje project.
...
if not DEBUG:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'postgres',
            'USER': 'postgres',
            'PASSWORD': 'ObjetosMaster2022$',
            'HOST': 'objdb.c9uqpg886ztz.us-east-1.rds.amazonaws.com',
            'PORT': '5432',
        }
    }
...
AUTH_USER_MODEL = 'Objetivos.Usuario'
